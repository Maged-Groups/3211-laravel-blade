...
@section('main-content')
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="max-w-md w-full space-y-8 bg-white dark:bg-gray-600 rounded-xl shadow-lg p-8">
            ...
            <form class="space-y-6" method="POST" action="{{ route('register') }}" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div>
                    ...
                    <input id="profile_photo" name="profile_photo" type="file" required value="{{ old('profile_photo') }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                <div>
                    <button type="submit"
